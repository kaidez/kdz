...
function doneMessage() {
  ...
  console.log( chalk.yellow( '3. You will need to run \"npm-check-updates\" to check for project modules updates and \"bower list\" to check for front-end dependency updates') );
