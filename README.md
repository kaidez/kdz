...
* This tool downloads files from a pre-defined root link in `kdz.js` that points to my GitHub repo. If you want to change that link, you would have to do that [here](https://github.com/kaidez/kdz/blob/master/kdz.js#L27).
